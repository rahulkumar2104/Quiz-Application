...
#        L2.config(text="Username is "+z[0][0]+"\nPassword is "+z[-1][1])
    ...
    log = Button(sup_frame,text='Already have a Account?',padx=5,pady=5,width=5,command = gotoLogin,bg="white",fg='grey')
...
def easy():
    ...
    easy_canvas = Canvas(e,width=720,height=440,bg="grey")
    easy_canvas.pack()
...
def medium():
    ...
    med_canvas = Canvas(m,width=720,height=440,bg="grey")
    med_canvas.pack()
...
def difficult():
    ...
    hard_canvas = Canvas(h,width=720,height=440,bg="grey")
    hard_canvas.pack()
    ...
    hardQ = [
                [
       "All keywords in Python are in _",
        "lower case",
        "UPPER CASE",
        "Capitalized",
        "None of the mentioned"
...
def showMark(mark):
    ...
    show_canvas = Canvas(sh,width=720,height=440,bg="grey")
    show_canvas.pack()
